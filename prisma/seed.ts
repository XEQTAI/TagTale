...
main()
  .catch((e) => {
    ...
    if (msg.includes("Can't reach database") || msg.includes('P1001')) {
      ...
      console.error('  • Supabase: set DATABASE_URL to your project URI (Dashboard → Database).')
      console.error('  • Local: install PostgreSQL for Windows — https://www.postgresql.org/download/windows/')
